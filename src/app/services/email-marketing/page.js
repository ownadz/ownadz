...
export async function generateMetadata() {
  return {
    alternates: {
      canonical: "https://www.ownadz.com/services/email-marketing",
    },
  };
}
...
const CONTENT = {
  ...
  description:
    "Engage and convert leads with targeted email campaigns, automation, and optimization.",
  bullets: [
    "Email strategy & segmentation",
    "Campaign design and copy support",
    "Automation workflows (drip/nurture)",
    "Deliverability and performance improvements",
  ],
};
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <p className="mt-4 text-slate-600 leading-7">
                Turn subscribers into customers using content that’s timed, targeted, and optimized.
              </p>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-6 md:p-8">
              ...
              <p className="mt-3 text-slate-600 leading-7">
                We’ll recommend a campaign and automation path based on your funnel.
              </p>
              <Link
                href="/contact"
