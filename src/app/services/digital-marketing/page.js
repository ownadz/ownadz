...
const CONTENT = {
  ...
  description:
    "End-to-end digital marketing services—strategy, execution, and growth tracking.",
  bullets: [
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <p className="mt-4 text-slate-600 leading-7">
                A unified plan across channels with clear deliverables and measurable
                results.
              </p>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-6 md:p-8">
              ...
              <p className="mt-3 text-slate-600 leading-7">
                We’ll map your goals to an execution roadmap with tracking from day one.
              </p>
              <Link
                href="/contact"
