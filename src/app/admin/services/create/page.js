...
const [service_faq_q8, setServiceFaqQ8] =
  ...
  const [service_process_title, setServiceProcessTitle] = useState("");
const [service_process_des, setServiceProcessDes] = useState("");

const [service_process_title1, setServiceProcessTitle1] = useState("");
const [service_process_des1, setServiceProcessDes1] = useState("");

const [service_process_title2, setServiceProcessTitle2] = useState("");
const [service_process_des2, setServiceProcessDes2] = useState("");

const [service_process_title3, setServiceProcessTitle3] = useState("");
const [service_process_des3, setServiceProcessDes3] = useState("");

const [service_process_title4, setServiceProcessTitle4] = useState("");
const [service_process_des4, setServiceProcessDes4] = useState("");

const [service_faq_d8, setServiceFaqD8] =
  useState("");
const [our_service_main_title, setOurServiceMainTitle] = useState("");
const [our_service_main_des, setOurServiceMainDes] = useState("");

const [our_service_list1, setOurServiceList1] = useState("");
const [our_service_list2, setOurServiceList2] = useState("");
const [our_service_list3, setOurServiceList3] = useState("");
const [our_service_list4, setOurServiceList4] = useState("");
const [our_service_list5, setOurServiceList5] = useState("");
const [our_service_list6, setOurServiceList6] = useState("");
const [our_service_list7, setOurServiceList7] = useState("");
const [our_service_list8, setOurServiceList8] = useState("");
const [our_service_list9, setOurServiceList9] = useState("");
const [our_service_list10, setOurServiceList10] = useState("");
const [our_service_list11, setOurServiceList11] = useState("");
const [our_service_list12, setOurServiceList12] = useState("");
const [our_service_list13, setOurServiceList13] = useState("");
const [our_service_list14, setOurServiceList14] = useState("");
const [our_service_list15, setOurServiceList15] = useState("");
const [our_service_list16, setOurServiceList16] = useState("");
const [our_service_list17, setOurServiceList17] = useState("");
const [our_service_list18, setOurServiceList18] = useState("");
const [our_service_list19, setOurServiceList19] = useState("");
const [our_service_list20, setOurServiceList20] = useState("");

const [service_canonical, setServiceCanonical] = useState("");
const [service_og_title, setServiceOgTitle] = useState("");
const [service_og_description, setServiceOgDescription] = useState("");
const [service_og_type, setServiceOgType] = useState("");
const [service_og_url, setServiceOgUrl] = useState("");
const [service_og_site_name, setServiceOgSiteName] = useState("");
const [service_og_image, setServiceOgImage] = useState(null);
const [service_schema, setServiceSchema] = useState("");
