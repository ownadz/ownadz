...
const [blog_breadcomes1, setBlogBreadcomes1] =
  useState("");

const [blog_breadcomeslink1, setBlogBreadcomeslink1] =
  useState("");

const [blog_breadcomes2, setBlogBreadcomes2] =
  useState("");

const [blog_breadcomeslink2, setBlogBreadcomeslink2] =
  useState("");

const [blog_breadcomes3, setBlogBreadcomes3] =
  useState("");

const [blog_Heading, setBlogHeading] =
  useState("");

const [blog_publish, setBlogPublish] =
  useState("");

const [blog_date, setBlogDate] =
  useState("");

const [blog_image, setBlogImage] =
  useState(null);

const [blog_des, setBlogDes] =
  useState("");
...
setBlogBreadcomeslink1(
  post.blog_breadcomeslink1 || ""
);
...
setBlogBreadcomeslink2(
  post.blog_breadcomeslink2 || ""
);
...
setBlogCardTitle1(post.blog_card_title1 || "");
setBlogCardDes1(post.blog_card_des1 || "");

setBlogCardNumber2(post.blog_card_number2 || "");
setBlogCardTitle2(post.blog_card_title2 || "");
setBlogCardDes2(post.blog_card_des2 || "");
setBlogCardSubtitle2(post.blog_card_subtitle2 || "");

setBlogCardList21(post.blog_card_list21 || "");
setBlogCardList22(post.blog_card_list22 || "");
setBlogCardList23(post.blog_card_list23 || "");
setBlogCardList24(post.blog_card_list24 || "");
setBlogCardList25(post.blog_card_list25 || "");

setBlogCardNumber3(post.blog_card_number3 || "");
setBlogCardTitle3(post.blog_card_title3 || "");
setBlogCardDes3(post.blog_card_des3 || "");
setBlogCardSubtitle3(post.blog_card_subtitle3 || "");

setBlogCardList31(post.blog_card_list31 || "");
setBlogCardList32(post.blog_card_list32 || "");
setBlogCardList33(post.blog_card_list33 || "");
setBlogCardList34(post.blog_card_list34 || "");

setBlogFaqMainTitle(post.blog_faq_main_title || "");

setBlogFaqTitle1(post.blog_faq_title1 || "");
setBlogFaqDes1(post.blog_faq_des1 || "");

setBlogFaqTitle2(post.blog_faq_title2 || "");
setBlogFaqDes2(post.blog_faq_des2 || "");

setBlogFaqTitle3(post.blog_faq_title3 || "");
setBlogFaqDes3(post.blog_faq_des3 || "");

setBlogFaqTitle4(post.blog_faq_title4 || "");
setBlogFaqDes4(post.blog_faq_des4 || "");

setBlogFaqTitle5(post.blog_faq_title5 || "");
setBlogFaqDes5(post.blog_faq_des5 || "");
